            ...
            return (
              <Box key={el._id} className='singlePro' onClick={()=>getProductDetail(el)}>
                ...
                <Box className='detail'>
                  ...
                  <Box className="price">
                    <Text>
                      <span style={{ fontSize: "20px" }}><b>&#8377; {el.price}</b></span>{" "}
                      <span style={{ color: "grey", fontSize: "13px" }}><strike>{el.mrl5}</strike></span>{" "}
                      <span style={{ color: 'red', fontSize: "13px" }}>{el.off2}</span>
                    </Text>
                    <Flex>
                      <Box bgColor={'green.800'} borderRadius={'30px'} w="15%" color="white" fontSize="13px" p='2px'>
                        <Flex>
                          <Text>{el.rating}</Text>
                          <Box margin='auto'>
                            <BsStarFill />
                      ...
                      <Text color='grey'>{el.ratingCount}</Text>
                    </Flex>
                  </Box>
                </Box>
